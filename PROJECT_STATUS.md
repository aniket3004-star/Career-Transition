...
- GitHub Actions run #34 (`35484034198`) passed on `51a75f347090874ac4095d09a5df410d7d65e0ac`.
- Privacy hardening removed personal birth data from `tests/test_input_contract.py` (`cbee045`) and `tests/test_cli.py` (`150eb043`).
- GitHub Actions run #38 (`35513397859`) completed successfully on current candidate `7ffc54633c90e0d6303cf84e199075e5390304b6` on 2026-09-20. This verifies the repository workflow at that SHA; it does not establish that every acceptance item is satisfied.
...
5. Historical ZIPs/artifacts remain unavailable for full inspection; preserve existing archive material and ask the user to supply source files if they are needed.
